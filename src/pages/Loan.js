...
import { FormGroup, Label, Input, Title, FormGroupRow, InputContainer, Button } from '../components/Form/Form.styles';
...
export const Loan = () => {
    ...
    const createLoan = (e) => {
        e.preventDefault()
        LoanService.loan(memberId, copyId).then(x=>{
            console.log(x)
        }).catch(err=>{
            console.log(err)
        })
                        ...
                        <FormGroup>
                            <FormGroupRow>
                                <InputContainer>
                                    ...
                                    <Input id="fname" type="text" name="fname" placeholder="Enter Member ID" onChange={e => setMemberId(e.target.value)} />
                                </InputContainer>

                                <InputContainer>
                                    <Label htmlFor="fname">Copy ID</Label>
                                    <Input id="fname" type="text" name="fname" placeholder="Enter Copy ID" onChange={e => setCopyId(e.target.value)} />
                                </InputContainer>
                            </FormGroupRow>
                        </FormGroup>
                    ...
                    <FormGroup>
                        ...
                        <FormGroupRow>
                            <InputContainer>
                                ...
                                <Input id="fname" type="text" name="fname" placeholder="Enter borrow date" onChange={e => setMemberId(e.target.value)} />
                            </InputContainer>

                            <InputContainer>
                                <Label htmlFor="fname">Book condition</Label>
                                <Input id="fname" type="text" name="fname" placeholder="Enter book condition" onChange={e => setCopyId(e.target.value)} />
                            </InputContainer>
                        </FormGroupRow>
                    </FormGroup>
                    <Button type="submit" bsStyle="primary">Sign-In</Button>
